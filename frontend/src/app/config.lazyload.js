          ...
          modules: [
              {
                  name: 'ngGrid',
                  files: [
                      'static/vendor/ng-grid/ng-grid.min.js',
                      'static/vendor/ng-grid/ng-grid.min.css',
                      'static/vendor/ng-grid/theme.css'
                  ]
              },
              {
                  name: 'ui.select',
                  files: [
                      'static/vendor/angular-ui-select/dist/select.min.js',
                      'static/vendor/angular-ui-select/dist/select.min.css'
                  ]
              },
              {
                  name:'angularFileUpload',
                  files: [
                    'static/vendor/angular-file-upload/angular-file-upload.min.js'
                  ]
              },
              {
                  name:'ui.calendar',
                  files: ['static/vendor/angular-ui-calendar/src/calendar.js']
              },
              {
                  name: 'ngImgCrop',
                  files: [
                      'static/vendor/ngImgCrop/compile/minified/ng-img-crop.js',
                      'static/vendor/ngImgCrop/compile/minified/ng-img-crop.css'
                  ]
              },
              {
                  name: 'angularBootstrapNavTree',
                  files: [
                      'static/vendor/angular-bootstrap-nav-tree/dist/abn_tree_directive.js',
              ...
              },
              {
                  name: 'toaster',
                  files: [
                      'static/vendor/angularjs-toaster/toaster.js',
                      'static/vendor/angularjs-toaster/toaster.css'
                  ]
              },
              {
                  name: 'textAngular',
                  files: [
                      'static/vendor/textAngular/dist/textAngular-sanitize.min.js',
                      'static/vendor/textAngular/dist/textAngular.min.js'
                  ]
              },
              {
                  name: 'vr.directives.slider',
                  files: [
                      'static/vendor/venturocket-angular-slider/build/angular-slider.min.js',
                      'static/vendor/venturocket-angular-slider/build/angular-slider.css'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular',
                  files: [
                      'static/vendor/videogular/videogular.min.js'
                  ]
              },
              {
              ...
              },
              {
                  ...
                  files: [
                      'static/vendor/videogular-buffering/vg-buffering.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.overlayplay',
                  files: [
                      'static/vendor/videogular-overlay-play/vg-overlay-play.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.poster',
                  files: [
                      'static/vendor/videogular-poster/vg-poster.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.imaads',
                  files: [
                      'static/vendor/videogular-ima-ads/vg-ima-ads.min.js'
                  ]
              }
          ]
      });
