 ...
 */
bracketapp.directive('ngbracket', ['data', 'layoutService',
    function(data, layoutService) {
        return {
            restrict: 'E',
            templateUrl: 'tpl/partials/bracket.html',
            replace: false,
            scope: {
                bracketData: '=',
            },
...
.directive('match', ['connectorService', 'layoutService', 'data', '$filter', 'highlight',
    function(connectorService, layoutService, data, $filter, highlight) {
        return {
            restrict: "E",
            scope: false,
            templateUrl: 'tpl/partials/match.html',
            replace: true,
            link: {
...
.directive('score', ['data',
    function(data) {
        return {
            ...
            templateUrl: 'tpl/partials/score.html',
...
.directive('team', ['data', 'highlight',
    function(data, highlight) {
        return {
            restrict: 'E',
            templateUrl: 'tpl/partials/team.html',
            replace: true,
            scope: {
                team: '=',
                teamdetails: '=',
