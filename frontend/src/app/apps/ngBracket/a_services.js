var bracketapp = angular.module('ngBracket', []);

/*
 * Finds nearest parent with given attribute and value
 */
bracketapp.findParentByAttribute = function(el, attr, value) {
 ...
 */
bracketapp.filter('iif', function() {
 ...
 */
bracketapp.filter('getById', function() {
 ...
 */
bracketapp.filter('reverse', function() {
 ...
 */
bracketapp.findFirstRound = function(data) {
 ...
 */
bracketapp.factory('highlight', function() {
	var highlight = {
		teamId: null,
		goldId: null,
		silverId: null,
