          ...
          $stateProvider
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('angularBootstrapNavTree').then(
                              function(){
                                 return $ocLazyLoad.load('static/src/app/controllers/tree.js');
                              }
                          );
                        }
                      ]
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad){
                          return $ocLazyLoad.load('toaster').then(
                              function(){
                                 return $ocLazyLoad.load('static/src/app/controllers/toaster.js');
                              }
                          );
                      }]
                  } */
              ...
              .state('app.ui.jvectormap', {
               ...
               /*   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad){
                          return $ocLazyLoad.load('static/src/app/controllers/vectormap.js');
                      }]
                  } */
              })
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('ngGrid').then(
                              function(){
                                  return $ocLazyLoad.load('static/src/app/controllers/grid.js');
                              }
                          );
                      }]
                  } */
              ...
              .state('app.form', {
               ...
               /*   resolve: {
                      deps: ['uiLoad',
                        function( uiLoad){
                          return uiLoad.load('static/src/app/controllers/form.js');
                      }]
                  } */
              })
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad){
                          return $ocLazyLoad.load('angularFileUpload').then(
                              function(){
                                 return $ocLazyLoad.load('static/src/app/controllers/file-upload.js');
                              }
                          );
                      }]
                  } */
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad){
                          return $ocLazyLoad.load('ngImgCrop').then(
                              function(){
                                 return $ocLazyLoad.load('static/src/app/controllers/imgcrop.js');
                              }
                          );
                      }]
                  }*/
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('ui.select').then(
                              function(){
                                  return $ocLazyLoad.load('static/src/app/controllers/select.js');
                              }
                          );
                      }]
                  }*/
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('vr.directives.slider').then(
                              function(){
                                  return $ocLazyLoad.load('static/src/app/controllers/slider.js');
                              }
                          );
                      }]
                  }*/
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('textAngular').then(
                              function(){
                                  return $ocLazyLoad.load('static/src/app/controllers/editor.js');
                              }
                          );
                      }]
                  }*/
                        ...
                        function( $ocLazyLoad, uiLoad ){
                          return uiLoad.load(
                            ['static/vendor/jquery/fullcalendar/fullcalendar.css',
                              ...
                              'static/vendor/jquery/moment.min.js',
              ...
              .state('app.mail', {
                 ...
                 /*  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['app/mail/mail.js',
              ...
              .state('layout.fullwidth', {
                ...
                /*   resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['static/src/app/controllers/vectormap.js'] );
                      }]
                  }*/
              })
              .state('layout.mobile', {
              ...
              .state('layout.app', {
                 ...
                 /*  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['static/src/app/controllers/tab.js'] );
                      }]
                  }*/
              })
              .state('apps', {
              ...
              .state('apps.note', {
                ...
                /*   resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['app/note/note.js',
              ...
              .state('apps.contact', {
                 ...
                 /*  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['app/contact/contact.js'] );
                      }]
                  }*/
              })
              .state('app.weather', {
